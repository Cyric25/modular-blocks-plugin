...
registerBlockType('modular-blocks/molecule-viewer', {
    ...
    save: ({ attributes }) => {
        ...
        const blockProps = useBlockProps.save({
            ...
            'data-pubchem-query': sourceType === 'pubchem' ? pubchemQuery : '',
            'data-pubchem-type': sourceType === 'pubchem' ? pubchemType : '',
            'data-smiles': sourceType === 'smiles' ? smilesString : '',
            'data-alphafold-id': sourceType === 'alphafold' ? alphafoldId : '',
            'data-structure-url': (sourceType === 'url' || sourceType === 'upload') ? structureUrl : '',
        ...
        return (
            <div {...blockProps}>
                <div className="chemviz-viewer__container" style={{
                    ...
                    <div className="chemviz-viewer__canvas"></div>
                    <div className="chemviz-viewer__loading">
                        {__('Lade Molekül...', 'modular-blocks-plugin')}
                    </div>
                </div>
